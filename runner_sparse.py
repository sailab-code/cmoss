...
def run_exp(args_cmd, base_path="./data", pretrained_net=None):
    ...
    net_options = {'c': ins.c,
                   ...
                   # 'closeness_loss_type': args_cmd.closeness_loss_type
    ...
    if args_cmd.wandb_tag is not None:
        ...
        wandb_tags = []
    if args_cmd.wandb:
        WANDB_PROJ = "confeat-revenant"
        WANDB_ENTITY = "sailab-of"
    ...
    v_proc.process_video(log_dict=log_dict)
    eval_sup_policy = v_proc.sup_policy
    eval_metrics_container = v_proc.metrics_container
    ins.close()
    outs.close()
...
def get_runner_parser():
    ...
    parser.add_argument('--dataset', type=str, default="rat_small")
